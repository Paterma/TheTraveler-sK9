...
<Accordion> <img className="img-fluid mx-auto d-block" id="fullLogo" src={logoFull} alt="The Traveler's K9 Logo" />
      <Accordion.Item eventKey="0">
        <Accordion.Header><strong>Puppy Package- &ensp; </strong>For 6 month old dogs or YOUNGER</Accordion.Header>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header><strong>Adult Dog Package- &ensp;</strong>   For dogs older than 6 months</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header> <strong>Advanced Dog Package with E-Collar Training- &ensp;</strong> For dogs who have completed Adult Dog Package
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header><strong>Private Lesson</strong></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="4">
        <Accordion.Header> <strong>Board and Train- &ensp;</strong> Minimum 1 week for all dogs. Length of stay determined at Evaluation</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="5">
        <Accordion.Header> <strong>Boarding Only- &ensp;</strong> Only offered for qualified clients. Contact for details and qualification</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="6">
        <Accordion.Header> <strong>Group Lessons- &ensp;</strong> Only offered for qualified clients</Accordion.Header>
        <Accordion.Body>
